 ...
 */
public class Find_Jobs_Fragment extends android.app.Fragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.find_jobs_fragment, container, false);
    ...
    private void loadWebsite() {
        ...
        if (netInfo != null && netInfo.isConnectedOrConnecting()) {
            mWebView.loadUrl("https://wazfnynow.com/محرك-البحث-عن-الوظائف/");
        } else {
